...
export default async function Footer() {
  ...
  return (
    <footer className="bg-background text-foreground py-12 desktop:py-16 relative border-t border-gray-200">
      <Container>
        <div className="grid grid-cols-1 desktop:grid-cols-4 gap-8 text-center desktop:text-left">
          
          {/* Logo & Brand */}
          <div className="flex flex-col items-center desktop:items-start">
            <Link href="/" className="flex flex-col items-center desktop:items-start space-y-3 hover:opacity-80 transition-opacity">
          ...
          <div>
            ...
            <div className="flex justify-center desktop:justify-start space-x-4">
